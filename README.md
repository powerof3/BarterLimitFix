...
Port of KernalEgg's [Barter Limit Fix](https://github.com/KernalsEgg/SKSE64Plugins/tree/main/BarterLimitFix)
...
## Building
```
git clone https://github.com/powerof3/BarterLimitFix.git
cd BarterLimitFix
